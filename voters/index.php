                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>         Cannot Vote More Than One Time.
                                        <?php
                                                }
                                            } else {
                                        ?>
                                                <button type="button" class="btn btn-md btn-success" onclick="castVote(<?php echo $election_id; ?>, <?php echo $candidate_id; ?>, <?php echo $_SESSION['user_id']; ?>)">Vote</button>
                                        <?php
                                            }
                                        ?>
                                    </td>
...
<script>
    function castVote(election_id, candidate_id, voters_id) {
        $.ajax({
            type: "POST",
            ...
            success: function(response) {
                if (response == "Success") {
                    alert("Vote is successfully casted!");
